...
| `WebGL-Template/` | Latest `MHS-Bridge-index.html` (the host page that wraps Unity builds and provides `__mhsBridgeConfig`). Unchanged from the 2026-05-12 build-automation drop — included here so this folder is a complete unit. |
